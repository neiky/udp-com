...
public class UdpSender implements AutoCloseable {
     ...
     * Parameterized contructor for UdpSender.
     *
     * @param address The local address of the socket (ip address, host name).
     * @param port    The local port of the socket.
     ...
     * Parameterized contructor for UdpSender.
     *
     * @param address The local address of the socket.
     * @param port    The local port of the socket.
     */
     ...
     *
     * @param address The address of the recipient (ip address, host name).
     ...
     *
     * @param remoteAddress The address of the recipient (ip address, host name).
     * @return this UdpSender.
     * @throws UnknownHostException if no IP address for the host could be found, or if a
     *                              scope_id was specified for a global IPv6 address.
     */
     ...
     *
     * @param remotePort The port of the recipient.
     * @return this UdpSender.
     */
    ...
    /**
     * @param message       The message to be sent.
     * @param remoteAddress The address of the destination.
     * @param remotePort    The port of the destination.
     * @return this UdpSender
     * @throws IOException if an I/O error occurs.
     */
     ...
     * Sends a UDP message.
     *
     * @param bytes The message to be sent as byte array.
     * @return this UdpSender.
     * @throws IOException if an I/O error occurs.
     */
