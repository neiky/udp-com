...
public class UdpTest {
    ...
    @Test
    public void useStringAddress() throws IOException, InterruptedException {
    ...
    @Test
    public void useMessageHandler() throws IOException, InterruptedException {
        assertNull(receivedMessage);
    ...
    @Test
    public void useINetAddress() throws IOException, InterruptedException {
        assertNull(receivedMessage);
        receiver = getUdpReceiver().start();
    ...
    @Test
    public void shouldHandleEmptyMessage() throws IOException, InterruptedException {
        assertNull(receivedMessage);
        receiver = getUdpReceiver().start();
    ...
    public void wrongSenderAddressThrowsException() throws IOException, InterruptedException {
        assertNull(receivedMessage);
        receiver = getUdpReceiver().start();
    ...
    public void receiverAddressMustBeGiven() throws IOException, InterruptedException {
        assertNull(receivedMessage);
        receiver = getUdpReceiver().start();
    ...
    public void messageMustNotBeNull() throws IOException, InterruptedException {
        assertNull(receivedMessage);
        receiver = getUdpReceiver().start();
    ...
    @Test(expected = UnknownHostException.class)
    public void wrongReciverAddressThrowsException() throws IOException, InterruptedException {
        assertNull(receivedMessage);
